...
function applyOwnerStack(error) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        ...
        const ownerStack = ((_getClientReact = getClientReact()) == null ? void 0 : _getClientReact.captureOwnerStack()) ?? ((_getServerReact = getServerReact()) == null ? void 0 : _getServerReact.captureOwnerStack());
        if (ownerStack) {
