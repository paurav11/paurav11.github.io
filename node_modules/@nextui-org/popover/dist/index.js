...
function usePopover(originalProps) {
  ...
  const getDialogProps = (props2 = {}) => ({
    ...
    "data-placement": (0, import_aria_utils2.getArrowPlacement)(ariaPlacement || "top", placementProp),
  ...
  const placement = (0, import_react3.useMemo)(
    () => (0, import_aria_utils2.getShouldUseAxisPlacement)(ariaPlacement || "top", placementProp) ? ariaPlacement || placementProp : placementProp,
