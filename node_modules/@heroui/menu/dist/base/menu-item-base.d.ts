import { MenuItemVariantProps, SlotsToClasses, MenuItemSlots } from '@heroui/theme';
...
type MenuItemBaseProps<T extends object = {}> = Omit<Props<T>, "onClick"> & Omit<MenuItemVariantProps, "hasDescriptionTextChild" | "hasTitleTextChild"> & AriaMenuItemProps & FocusableProps & PressEvents & {
    /**
