...
declare function useMenuItem<T extends object>(originalProps: UseMenuItemProps<T>): {
    ...
    getKeyboardShortcutProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
    getSelectedIconProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
};
