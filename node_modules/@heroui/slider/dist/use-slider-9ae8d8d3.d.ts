...
import { PropGetter, HTMLHeroUIProps, DOMAttributes } from '@heroui/system';
import { SliderVariantProps, SlotsToClasses, SliderSlots } from '@heroui/theme';
...
declare function useSliderThumb(props: UseSliderThumbProps): {
    ...
    getThumbProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
    getTooltipProps: () => TooltipProps;
    getInputProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
};
type UseSliderThumbReturn = ReturnType<typeof useSliderThumb>;

interface SliderThumbProps extends UseSliderThumbProps {
}
declare const SliderThumb: _heroui_system.InternalForwardRefRenderFunction<"div", SliderThumbProps, never>;
...
declare function useSlider(originalProps: UseSliderProps): {
    ...
    getTrackWrapperProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getLabelWrapperProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getLabelProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getValueProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getTrackProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getFillerProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    ...
    getStartContentProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getEndContentProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
};
