...
declare function useSelect<T extends object>(originalProps: UseSelectProps<T>): {
    ...
    getTriggerProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    ...
    getSpinnerProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getMainWrapperProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    ...
    getInnerWrapperProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getHelperWrapperProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getDescriptionProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
    getErrorMessageProps: PropGetter<Record<string, unknown>, DOMAttributes<_heroui_system.DOMElement>>;
