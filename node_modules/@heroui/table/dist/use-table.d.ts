...
import { TableVariantProps, TableReturnType, SlotsToClasses, TableSlots } from '@heroui/theme';
...
type UseTableProps<T = object> = Props<T> & TableStateProps<T> & Omit<AriaTableProps, "layout"> & TableVariantProps;
...
declare function useTable<T extends object>(originalProps: UseTableProps<T>): {
    ...
    getTableProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
};
