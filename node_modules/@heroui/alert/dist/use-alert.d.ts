...
declare function useAlert(originalProps: UseAlertProps): {
    ...
    color: any;
    getCloseButtonProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
    handleClose: () => void;
    isVisible: boolean;
    onClose: (() => void) | undefined;
    getAlertIconProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
    getIconWrapperProps: PropGetter<Record<string, unknown>, _heroui_system.DOMAttributes<_heroui_system.DOMElement>>;
};
