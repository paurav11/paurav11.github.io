(function (global, factory) {
  ...
  function useGoogleMap() {
    invariant(!!react.useContext, 'useGoogleMap is React hook and requires React version 16.8+');
  ...
  function GoogleMapFunctional(_ref) {
    ...
    return jsxRuntime.jsx("div", {
      ...
      children: jsxRuntime.jsx(MapContext.Provider, {
        value: map,
  ...
  class LoadScript extends react.PureComponent {
    constructor() {
      super(...arguments);
      _defineProperty(this, "check", react.createRef());
      _defineProperty(this, "state", {
        loaded: false
      });
    ...
    render() {
      return jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [jsxRuntime.jsx("div", {
          ref: this.check
        }), this.state.loaded ? this.props.children : this.props.loadingElement || jsxRuntime.jsx(DefaultLoadingElement, {})]
      });
    }
  }
  ...
  ***************************************************************************** */
  ...
  function DrawingManagerFunctional(_ref) {
    ...
    var [rectanglecompleteListener, setRectangleCompleteListener] = react.useState(null);
    // Order does matter
    react.useEffect(() => {
      if (instance !== null) {
        instance.setMap(map);
  ...
  function MarkerFunctional(_ref) {
    ...
    var [zIndexChangedListener, setZindexChangedListener] = react.useState(null);
    // Order does matter
    react.useEffect(() => {
      if (instance !== null) {
        instance.setMap(map);
  ...
  ***************************************************************************** */
  ...
  function RectangleFunctional(_ref) {
    ...
    var [clickListener, setClickListener] = react.useState(null);
    var [dragListener, setDragListener] = react.useState(null);
    var [boundsChangedListener, setBoundsChangedListener] = react.useState(null);
    // Order does matter
    react.useEffect(() => {
      if (instance !== null) {
        instance.setMap(map);
  ...
  function CircleFunctional(_ref) {
    ...
    var [dragListener, setDragListener] = react.useState(null);
    var [centerChangedListener, setCenterChangedListener] = react.useState(null);
    var [radiusChangedListener, setRadiusChangedListener] = react.useState(null);
    // Order does matter
    react.useEffect(() => {
      if (instance !== null) {
        instance.setMap(map);
  ...
  function DataFunctional(_ref) {
    ...
    var [setPropertyListener, setSetPropertyListener] = react.useState(null);
    // Order does matter
    react.useEffect(() => {
      if (instance !== null) {
        instance.setMap(map);
  ...
  class OverlayView extends react.PureComponent {
    ...
    render() {
      ...
      if (paneEl) {
        return ReactDOM__namespace.createPortal(jsxRuntime.jsx("div", {
